...
export const data = {
  ...
  "get_block": true,
    ...
    "docker": {
      ...
      "labels": {
        "domain": "vote.wise",
        "defaultLabels": [ () => "maintainer=\"The Wise Team (https://wise-team.io/) <jedrzejblew@gmail.com>\"", () => "vote.wise.wise-version=\"2.2.4\"", () => "vote.wise.license=\"MIT\"", () => "vote.wise.repository=\"steem-wise-core\"" ],
      },
      "generateDockerfileFrontMatter": () => "LABEL maintainer=\"The Wise Team (https://wise-team.io/) <jedrzejblew@gmail.com>\"\nLABEL vote.wise.wise-version=\"2.2.4\"\nLABEL vote.wise.license=\"MIT\"\nLABEL vote.wise.repository=\"steem-wise-core\"",
    },
    "repository": {
      "github": {
