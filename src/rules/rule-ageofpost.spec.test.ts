...
describe("test/unit/rule-ageofpost.spec.ts", () => {
    describe("AgeOfPostRule", function() {
        const tests: {
            mode: AgeOfPostRule.Mode;
            unit: AgeOfPostRule.TimeUnit;
            value: number;
            deltaTimeS: number;
            pass: boolean;
        }[] = [
            {
                mode: AgeOfPostRule.Mode.OLDER_THAN,
                unit: AgeOfPostRule.TimeUnit.DAY,
                value: 5,
                deltaTimeS: -(6 * 24 * 3600),
                pass: true,
            },
            {
                mode: AgeOfPostRule.Mode.OLDER_THAN,
                unit: AgeOfPostRule.TimeUnit.DAY,
                value: 5,
                deltaTimeS: -(4 * 24 * 3600),
                pass: false,
            },
            {
                mode: AgeOfPostRule.Mode.YOUNGER_THAN,
                unit: AgeOfPostRule.TimeUnit.DAY,
                value: 5,
                deltaTimeS: -(6 * 24 * 3600),
                pass: false,
            ...
            {
                mode: AgeOfPostRule.Mode.OLDER_THAN,
                unit: AgeOfPostRule.TimeUnit.HOUR,
                value: 5,
                deltaTimeS: -(6 * 3600),
                pass: true,
            },
            ...
            {
                mode: AgeOfPostRule.Mode.OLDER_THAN,
                unit: AgeOfPostRule.TimeUnit.MINUTE,
                value: 5,
                deltaTimeS: -(6 * 60),
                pass: true,
            },
            ...
            {
                mode: AgeOfPostRule.Mode.OLDER_THAN,
                unit: AgeOfPostRule.TimeUnit.SECOND,
                value: 5,
                deltaTimeS: -6,
                pass: true,
            },
