...
// wise imports
import { VotesCountRule, SendVoteorder, ValidationException, Wise } from "../wise";
import { ValidationContext } from "../validation/ValidationContext";
import { FakeWiseFactory } from "../_test/util/FakeWiseFactory";
import {
    wise_rule_votes_count_encode,
    wise_rule_votes_count,
    wise_rule_votes_count_decode,
} from "../protocol/versions/v2/rules/rule-votes-count-schema";
...
describe("test/unit/rule-votescount.spec.ts", () => {
    describe("VotesCountRule.validate", function() {
        const tests: { mode: VotesCountRule.Mode; value: number; author: string; permlink: string; pass: boolean }[] = [
            {
                mode: VotesCountRule.Mode.EQUAL,
            ...
            {
                mode: VotesCountRule.Mode.MORE_THAN,
                author: "noisy",
                permlink:
                    "what-we-can-say-about-steem-users-based-on-traffic-generated-to-steemprojects-com-after-being-3-days-on-top-of-trending-page",
                value: 139,
            ...
            {
                mode: VotesCountRule.Mode.LESS_THAN,
                author: "noisy",
                permlink:
                    "what-we-can-say-about-steem-users-based-on-traffic-generated-to-steemprojects-com-after-being-3-days-on-top-of-trending-page",
                value: 139,
