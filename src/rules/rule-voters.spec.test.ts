...
// wise imports
import { AuthorsRule, SendVoteorder, Wise, ValidationException, TagsRule, Api } from "../wise";
import { ValidationContext } from "../validation/ValidationContext";
import { FakeWiseFactory } from "../_test/util/FakeWiseFactory";
import { VotersRule } from "../rules/VotersRule";
import {
    wise_rule_voters_decode,
    wise_rule_voters_encode,
    wise_rule_voters,
} from "../protocol/versions/v2/rules/rule-voters-schema";
        ...
        const tests = [
            {
                ...
                permlink: "4jxxyd-test",
                pass: true,
                desc: "all post voters are on the 'one-of' list => pass",
            },
            {
                rule: new VotersRule(VotersRule.Mode.ONE, [
                    "albakerki",
                    "gtg",
                    "lukmarcus",
                    "sisters",
                    ...
                    "pibyk",
                    "guest123",
                ]), // noisy is missing on the list
                author: "jblew",
                permlink: "witajcie-steemianie-przybywam-jedrzej-lewandowski",
                pass: false,
                desc: "only one of the post voters in not on the list => fail",
            },
            {
                rule: new VotersRule(VotersRule.Mode.NONE, ["steemprojects2"]),
                author: "jblew",
                permlink:
                    "wise-jak-glosowac-za-cudze-vp-a-takze-czym-jest-wise-i-dlaczego-powstal-czesc-pierwsza-cyklu-o-wise",
                pass: true,
                desc: "none of the voters is on the list => pass",
            },
            {
                ...
                permlink:
                    "wise-jak-glosowac-za-cudze-vp-a-takze-czym-jest-wise-i-dlaczego-powstal-czesc-pierwsza-cyklu-o-wise",
                pass: false,
                desc: "one of the voters is on the list => fail",
            },
            {
                ...
                permlink:
                    "wise-jak-glosowac-za-cudze-vp-a-takze-czym-jest-wise-i-dlaczego-powstal-czesc-pierwsza-cyklu-o-wise",
                pass: true,
                desc: "only one of the voters is on the list => pass",
            },
            {
                ...
                permlink:
                    "wise-jak-glosowac-za-cudze-vp-a-takze-czym-jest-wise-i-dlaczego-powstal-czesc-pierwsza-cyklu-o-wise",
                pass: false,
                desc: "none of the voters is on the list => fail",
            },
            {
                rule: new VotersRule(VotersRule.Mode.ALL, ["gtg", "noisy", "perduta"]),
                author: "nicniezgrublem",
                permlink: "b52e6300-9011-11e8-b2de-f7be8f055a16",
                pass: true,
                desc: "all usernames from the list votes on the post => pass",
            },
            {
                ...
                permlink: "b52e6300-9011-11e8-b2de-f7be8f055a16",
                pass: false,
                desc: "not all usernames from the list votes on the post => fail",
            },
        ];
        tests.forEach(test =>
            it(test.rule.mode + ": Should " + (test.pass ? "pass" : "fail") + ": " + test.desc, () => {
