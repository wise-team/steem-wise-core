...
// wise imports
import { FirstPostRule, SendVoteorder, ValidationException, Wise } from "../wise";
import { ValidationContext } from "../validation/ValidationContext";
import { FakeWiseFactory } from "../_test/util/FakeWiseFactory";
import {
    wise_rule_first_post_encode,
    wise_rule_first_post_decode,
    wise_rule_first_post,
} from "../protocol/versions/v2/rules/rule-first-post-schema";
...
describe("test/unit/rule-firstpost.spec.ts", () => {
